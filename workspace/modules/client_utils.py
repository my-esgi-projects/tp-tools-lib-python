...
dict_menus = {
    ...
    "3": {
        "label": "3. Display Informations About Process",
        "submenu": {
            "1": {
                "label": "\t 1. Show os process",
                "action": "os_process"
            },
            "2": {
                "label": "\t 2. Show application process",
                "action": "application_process"
            },
            "0": {
                "label": "\t 0. Back to main menu",
                "action": "back_to_main_menu"
    ...
    "4": {
        ...
        "submenu": {
            ...
            "4": {
                "label": "\t 4. Show used memory in percentage",
                "action": "memory_used_percentage",
                "final": "Percentage of memory used is : "
            },
